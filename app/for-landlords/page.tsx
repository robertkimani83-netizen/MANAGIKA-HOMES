    ...
    <main>
      ...
      <div className="lp-root">
        <div className="lp-hero">
          <div className="lp-wrap lp-hero-inner">
            ...
            <div className="lp-hero-ctas">
              <a className="lp-btn lp-btn-gold" href="#pricing">See pricing</a>
              <a className="lp-btn lp-btn-ghost" href="mailto:robertkimani83@gmail.com?subject=Managika%20Homes%20for%20my%20properties">Talk to us</a>
            </div>
          </div>
        ...
        <footer className="lp-footer">
          <div className="lp-wrap">© 2026 Managika Homes · <a href="mailto:robertkimani83@gmail.com">robertkimani83@gmail.com</a> · managikahomes.co.ke</div>
        </footer>
      </div>
    </main>
  );
