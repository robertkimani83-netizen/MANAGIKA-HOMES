  ...
  <section className="flex flex-1 items-center justify-center px-6 py-16">
    <div className="w-full max-w-md text-center">
      ...
      <div className="mt-8 flex flex-col gap-4">
        <a href="/landlord/login" className="rounded-lg bg-slate-900 px-6 py-4 font-semibold text-white hover:bg-slate-800">Landlord Login</a>
        <a href="/tenant/login" className="rounded-lg border border-slate-300 bg-white px-6 py-4 font-semibold text-slate-700 hover:bg-slate-50">Tenant Login</a>
      </div>
    </div>
  </section>
