...
<div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-amber-400 via-orange-500 to-amber-400" />
    ...
    <div className="mx-auto flex w-full max-w-6xl items-center justify-between">
      <div>
        ...
        <p className="text-sm text-slate-300">Property Management Made Simple</p>
      </div>
    </div>
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center py-16 text-center">
      ...
      <p className="mt-6 max-w-xl text-lg text-slate-300">One home for your properties, your rent, your maintenance and your peace of mind — whichever side of the door you're on.</p>
      ...
      <div className="mt-10 flex flex-col gap-4 sm:flex-row">
        ...
        <a href="/tenant/login" className="rounded-lg border-2 border-white/30 bg-white/10 px-8 py-4 text-base font-semibold text-white backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/20">I'm a Tenant</a>
      </div>
    </div>

    <div className="mx-auto grid w-full max-w-6xl grid-cols-2 gap-4 border-t border-white/10 pt-8 text-center sm:grid-cols-4">
      <div>
        <p className="text-2xl">🏠</p>
        <p className="mt-2 text-sm text-slate-300">Properties & Units</p>
      </div>
      <div>
        <p className="text-2xl">💰</p>
        <p className="mt-2 text-sm text-slate-300">Rent & Payments</p>
      </div>
      <div>
        <p className="text-2xl">🔧</p>
        <p className="mt-2 text-sm text-slate-300">Maintenance Requests</p>
      </div>
      <div>
        <p className="text-2xl">👥</p>
        <p className="mt-2 text-sm text-slate-300">Tenant Records</p>
      </div>
    </div>
  </section>
