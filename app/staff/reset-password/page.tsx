...
// Landing page for the link in Supabase's password-reset email, for
// caretakers/team members. See app/landlord/reset-password/page.tsx for
// how the recovery-token handoff works - same mechanism, different
      ...
      <div className="mx-auto flex min-h-[80vh] max-w-md items-center justify-center">
        <div className="w-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 text-center">
            <a href="/staff/login" className="text-sm font-medium text-slate-500 hover:text-slate-900">← Back to Login</a>
          </div>
        </div>
      </div>
    </main>
