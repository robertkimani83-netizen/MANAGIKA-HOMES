...
// Landing page for the link in Supabase's password-reset email - used
// only by tenants who reset via email. Tenants who reset via phone number
// never see this page; they complete the reset entirely on
// /tenant/login (see the "forgot" mode there), since there's no email
// link involved.
      ...
      <div className="mx-auto flex min-h-[80vh] max-w-md items-center justify-center">
        <div className="w-full rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 text-center">
            <a href="/tenant/login" className="text-sm font-medium text-slate-500 hover:text-slate-900">← Back to Login</a>
          </div>
        </div>
      </div>
    </main>
