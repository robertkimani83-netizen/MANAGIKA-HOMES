...
const SW: Record<string, string> = {
  ...
  // Account statement
  "🧾 My Statement": "🧾 Taarifa Yangu ya Akaunti",
  "← Back to My Account": "← Rudi kwenye Akaunti Yangu",
  "Account Statement": "Taarifa ya Akaunti",
  "Statement date": "Tarehe ya taarifa",
  "Total charged": "Jumla iliyodaiwa",
  "Total paid": "Jumla iliyolipwa",
  "Amount owed": "Kiasi kinachodaiwa",
  "Credit": "Salio la ziada",
  "Charged": "Imedaiwa",
  "Paid": "Imelipwa",
  "Balance": "Salio",
  "Payment": "Malipo",
  "Water": "Maji",
  "Garbage": "Taka",
  "No charges or payments yet.": "Hakuna madai wala malipo bado.",
  "A balance in brackets means the tenant has paid ahead.": "Salio kwenye mabano linamaanisha mpangaji amelipa mapema.",
  // Photo on a complaint
  "Photo (optional)": "Picha (si lazima)",
  "📷 Photo attached": "📷 Picha imeambatishwa",
  "Remove photo": "Ondoa picha",
  "Submitting...": "Inatuma...",
  "Please choose a photo file.": "Tafadhali chagua faili ya picha.",
  "Could not attach the photo: ": "Picha haikuweza kuambatishwa: ",
  // Login page
